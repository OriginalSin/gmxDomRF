...
`;
    ...
    */
    ...
    /* src\Filters\Filters.svelte generated by Svelte v3.20.1 */
    ...
    // (276:4) {#each Object.keys(filterLayers) as k}
    ...
    function create_if_block_1(ctx) {
    	...
    	return {
    		c() {
    			...
    			input = element("input");
    			label = element("label");
    			label.textContent = `${/*locale*/ ctx[11].searchByGeom || "Поиск объектов по пересечению с контуром (создайте контур на Геопортале)"}`;
    			t2 = space();
    			...
    			attr(input, "title", input_title_value = /*locale*/ ctx[11].drawOrSelect || "Нарисовать или выбрать объект по правой кнопке на вершине");
    		...
    		m(target, anchor, remount) {
    			...
    			if (remount) dispose();
    			dispose = listen(input, "change", /*createDrawing*/ ctx[13]);
    		},
    		p(ctx, dirty) {
    ...
    function create_if_block_3(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			if (dirty[0] & /*currLayer, clearData*/ 32784) {
    ...
    // (291:2) {#if currLayer.filters[field].datalist}
    ...
    // (293:4) {#each currLayer.filters[field].datalist as pt}
    ...
    // (286:1) {#each Object.keys(currLayer.filters) as field}
    function create_each_block(ctx) {
    	...
    	return {
    		...
    		m(target, anchor, remount) {
    			...
    			append(div2, t3);
    			if (remount) dispose();
    			dispose = listen(input, "change", /*clearData*/ ctx[15]);
    		},
    		p(ctx, dirty) {
    ...
    function create_fragment(ctx) {
    	...
    	return {
    		c() {
    			...
    			div2 = element("div");
    			div0 = element("div");
    			div0.textContent = `${/*locale*/ ctx[11].selectLayer || "Выберите слой"}`;
    			t1 = space();
    			div1 = element("div");
    			...
    			button0.textContent = `${/*locale*/ ctx[11].createByFilter || "Создать слой по фильтру"}`;
    			t5 = space();
    			a = element("a");
    			iframe_1 = element("iframe");
    			t6 = space();
    			button1 = element("button");
    			button1.textContent = `${/*locale*/ ctx[11].createExport || "Экспорт в Excel"}`;
    			t8 = space();
    			if (if_block1) if_block1.c();
    			attr(div0, "class", "title");
    			option.__value = "";
    			...
    			attr(a, "onload", /*setHidden*/ ctx[14]);
    		...
    		m(target, anchor, remount) {
    			...
    			dispose = [
    				listen(window_1, "focus", /*setHidden*/ ctx[14]),
    				listen(select, "change", /*changeLayer*/ ctx[12]),
    				listen(button0, "click", /*createFilterLayer*/ ctx[17]),
    				listen(iframe_1, "focus", /*clearData*/ ctx[15]),
    				listen(button1, "click", /*createExport*/ ctx[16])
    			];
    		},
    		p(ctx, dirty) {
    ...
    function instance($$self, $$props, $$invalidate) {
    			...
    			getColumnStat(id).then(arr => {
    				...
    				arr.forEach(it => {
    					if (it.field) {
    						...
    						$$invalidate(0, error = locale.error || "Ошибка");
    					}
    				});
    	...
    	leafletMap.subscribe(value => {
    		...
    		map.gmxDrawing.contextmenu.insertItem(
    			{
    				callback: privaz,
    				text: locale.snap || "Привязать к фильтру"
    			},
    			0,
    			"points"
    		);
    	...
    	const createFilterLayer = ev => {
    		if (drawingChecked && !currDrawingObjArea) {
    			$$invalidate(0, error = locale.needDraw || "Необходимо нарисовать контур");
    ...
    function create_if_block$1(ctx) {
    	...
    	return {
    		...
    		p(ctx, dirty) {
    			...
    			if (!updating_openSidebar && dirty & /*openSidebar*/ 2) {
    ...
    function create_fragment$1(ctx) {
    	...
    	return {
    		...
    		p(ctx, [dirty]) {
    			if (!current || dirty & /*tab*/ 1 && a_class_value !== (a_class_value = "nav-link " + (/*tab*/ ctx[0] === "filters" ? "active" : "-"))) {
    				attr(a, "class", a_class_value);
    			}
...
//# sourceMappingURL=filter_1.0.js.map
